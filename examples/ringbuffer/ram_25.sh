...
THOR_PGRM_DIR=/home/alex/git/digital_rf/python/tools

# ram disk buffer for fast i/o
RINGBUFFER_DIR=/dev/shm/hf25
# make this about a few GB more than a full sounder (25 GB)
RINGBUFFER_SIZE=27GB

# start receiving to a ringbuffer
rm -Rf $RINGBUFFER_DIR
python3 $THOR_PGRM_DIR/thor.py -m 192.168.10.2 -d A:A -c cha -f $CENTER_FREQ -r $SAMPLE_RATE $RINGBUFFER_DIR &
sleep 10
